...
public class ClusterSumFiledGroupingStormTopology2 {
    ...
    public static class SumBolt extends BaseRichBolt {
        ...
        public void execute(Tuple input) {
            ...
            System.out.println("Thread id:" + Thread.currentThread().getId() + ", recieve data is" + value);
        }
    ...
    public static void main(String[] args) {
        ...
        // 创建集群模式运行
        String topName = ClusterSumFiledGroupingStormTopology2.class.getSimpleName();
        try {
            StormSubmitter.submitTopology(topName, new Config(), builder.createTopology());
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
